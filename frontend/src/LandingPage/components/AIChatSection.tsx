...
function ChatTextBlock({ textProgress }: IChatTextBlockProps): React.ReactElement {
  return (
    ...
    >
      <p className="mb-4 text-sm font-bold tracking-[0.3em] text-cyan-600 uppercase dark:text-cyan-400">
        AI Assistant
      </p>
      <h2 className="mb-6 text-4xl font-black leading-[1.1] text-gray-900 sm:text-5xl lg:text-6xl xl:text-7xl dark:text-white">
        Your AI
        <br />
        <span className="bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-600 bg-clip-text text-transparent dark:from-cyan-400 dark:via-blue-400 dark:to-cyan-300">
          Travel Brain
        </span>
      </h2>
